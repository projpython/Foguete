...
class Interface_Grafica: # abrir a classe interface
    ...
    def Cria_Interface(self): # para criar a interface
        ...
        Botao1.place(relx = 0.57, rely = 0.45, relwidth = 0.20, relheight = 0.15)
        ...
        Botao2.place(relx = 0.57, rely = 0.65, relwidth = 0.20, relheight = 0.15)
        
        Botao_Ajuda_Botao1 = tk.Button(text='?', font = helv37, command=self.Ajuda1) 
        Botao_Ajuda_Botao1.place(relx = 0.77, rely = 0.45, relwidth = 0.03, relheight = 0.15)
        
        Botao_Ajuda_Botao2 = tk.Button(text='?', font = helv37, command=self.Ajuda2) 
        Botao_Ajuda_Botao2.place(relx = 0.77, rely = 0.65, relwidth = 0.03, relheight = 0.15)
        
        Botao_Ajuda_Input = tk.Button(text='?', font = helv37, command=self.AjudaInput) 
        Botao_Ajuda_Input.place(relx = 0.8, rely = 0.2, relwidth = 0.03, relheight = 0.1)
    ...
    def Ajuda1(self):#função para auxiliar o usuário com o botao 1
        ...
        msg.showinfo("Ajuda","Este botão abre um pop up no qual há um gráfico da altura em função do tempo. Este gráfico pode ser salvo")
        
    def Ajuda2(self):#função para auxiliar o usuário com o botao 2
        
        msg.showinfo("Ajuda","Este botão abre um pop up no qual há um gráfico da distância percorrida no eixo X e Y. Estes dados podem ser interpretados como a projeção do trajeto do foguete no solo. Este gráfico pode ser salvo")
    
    def AjudaInput(self):#função para auxiliar o usuário com o botao input
        
        msg.showinfo("Ajuda","Através deste botão o usuário pode buscar o arquivo em .csv que deseja analisar, com o auxilio do explorador de arquivos")
